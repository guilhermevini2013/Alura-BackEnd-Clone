...
@Component
public class TrainingNameNotNullStrategy implements IValidatorFilterContent<TrainingSearchDTO, TrainingReadDTO> {
    private ContentRepository contentRepository;
    private FilterSpecification<Content> filterSpecification;

    public TrainingNameNotNullStrategy(ContentRepository contentRepository, FilterSpecification<Content> filterSpecification) {
